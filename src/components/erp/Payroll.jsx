  ...
  const renderView = () => {
    switch (activeTab) {
      case "summary":
        return (
          ...
          >
            ...
            <div
              className="payroll-summary-panels"
              style={{
                display: "grid",
                gap: "24px",
              }}
            >
              <div
                className="glass-card payroll-structure-panel"
                style={{ padding: "24px" }}
              >
                ...
                >
                  {salaryStructures.map((struct, i) => (
                    <div
                      key={i}
                      className="payroll-structure-card"
                      style={{
                        padding: "20px",
                        backgroundColor: "var(--tag-bg)",
                        borderRadius: "12px",
              ...
              <div
                className="glass-card payroll-payslip-panel"
                style={{ padding: "24px" }}
              >
                <h3 style={{ fontWeight: "700", marginBottom: "20px" }}>
                  Recent Payslips
      ...
      case "compliance":
        return (
          <div
            className="glass-card payroll-compliance"
            style={{ padding: "24px" }}
          >
            ...
            >
              {[
                ...
                <div
                  key={i}
                  className="payroll-compliance-card"
                  style={{
                    padding: "24px",
                    backgroundColor: "var(--tag-bg)",
                    borderRadius: "12px",
            ...
            <div
              className="payroll-compliance-reminder"
              style={{
                marginTop: "32px",
                padding: "24px",
            ...
            >
              ...
              <p style={{ fontSize: "14px", color: "var(--text-muted)" }}>
                The quarterly TDS return (Form 24Q) is due in 12 days. Please
                ensure all payroll approvals for March are finalized.
              </p>
            </div>
          </div>
        );
      ...
      case "reports":
        return (
          <div
            className="glass-card payroll-reports"
            style={{ padding: "24px" }}
          >
            <div
              className="payroll-reports-header"
              style={{
                display: "flex",
                justifyContent: "space-between",
                alignItems: "center",
            ...
            >
              ...
              <div
                className="payroll-reports-actions"
            ...
            >
              {[
                ...
                {
                  name: "Employee Reimbursement Log",
                  type: "Claims",
                  size: "850 KB",
                  updated: "1 week ago",
                },
                {
                  name: "PF Contribution Statement",
                  type: "Statutory",
                  size: "3.1 MB",
                  updated: "Mar 15",
                },
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      >
        ...
        <div>
          ...
          <p style={{ fontSize: "14px", color: "var(--text-muted)" }}>
            Manage employee compensations, taxes, and reports.
          </p>
        </div>
      </header>
