...
const PartnerMaster = () => {
  ...
  const partners = {
    customers: [
      ...
      {
        id: "C2",
        name: "Infinite Media Group",
        contact: "Sarah Miller",
        email: "sarah@infinite.io",
        ...
        >
          <button
            ...
            style={{
              ...
              fontWeight: "600",
              backgroundColor:
                activeSubTab === "customers" ? "var(--primary)" : "transparent",
              color:
                activeSubTab === "customers" ? "white" : "var(--text-muted)",
            }}
          >
            Customers
          </button>
          <button
            ...
            style={{
              ...
              fontWeight: "600",
              backgroundColor:
                activeSubTab === "vendors" ? "var(--primary)" : "transparent",
