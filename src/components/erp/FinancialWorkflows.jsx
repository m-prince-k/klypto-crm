...
const FinancialWorkflows = () => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
      <div
        className="responsive-grid-2 erp-finance-switch"
      ...
      >
        <button
          ...
          style={{
            ...
            backgroundColor:
              view === "purchases" ? "var(--icon-bg)" : "var(--bg-card)",
          }}
        >
          <div
            style={{
          ...
          style={{
            ...
            border:
              view === "invoices"
                ...
                : "1px solid var(--border)",
            backgroundColor:
              view === "invoices" ? "var(--icon-bg)" : "var(--bg-card)",
          }}
        >
          <div
            style={{
          ...
          <p style={{ fontSize: "13px", color: "var(--text-muted)" }}>
            Track client billing and receivables.
          </p>
        </button>
      </div>
